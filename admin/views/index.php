...
if(isset($_GET['page_layout'])){
    switch ($_GET['page_layout']){
        case 'list_product' : require_once "../controllers/list_product.php";break;
        case 'insert_product': require_once "../controllers/insert_product.php"; break;
        case 'update_product' :
            require_once "../controllers/update_product.php"; break;
        case 'delete_product' : require_once "../controllers/delete_product.php";break;
    }
}
else {
    require_once "../controllers/list_product.php";
}
?>
