...
<div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start bg-dark" >
    ...
    <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center align-items-center mb-md-0">
        <a href="../../views/product.php" class="navbar-brand">
            <h3 class="px-5">
                <i class="fas fa-shopping-basket"></i>Shopping Cart
            </h3>
        </a>
        <li><a href="../../admin/views/index.php" class="nav-link px-2 text-secondary">ADMIN</a></li>
        <li><a href="../../admin/views/index.php" class="nav-link px-2 text-white">Product</a></li>
    ...
    <div class="dropdown p-2  bg-dark rounded-pill">
        <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
            <img src="../../assets/images/user.jpg" alt="images" width="50" height="50" class="rounded-circle me-2">
