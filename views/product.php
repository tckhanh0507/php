...
include "../controllers/product/acction_product.php";
?>
    ...
    <div class="carousel">
        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="banner" style="background-image: url(../assets/images/1.webp);height: 80vh;
        background-repeat: no-repeat; background-size: cover; background-position: center;padding:6rem 0; ">
                ...
                <div class="carousel-item">
                    <div class="banner" style="background-image: url(../assets/images/2.webp);height: 80vh;
        ...
        background-repeat: no-repeat; background-size: cover; background-position: center;padding:6rem 0; ">
                ...
                <div class="carousel-item">
                    <div class="banner" style="background-image: url(../assets/images/3.webp);height: 80vh;
       ...
       <div class="container-fluid">
           <div class="row text-center py-5 ">
               ...
               while ($row = mysqli_fetch_assoc($result)){
                   component($row['name'],$row['price'],"../assets/".$row['image'],$row['id']);
               }
               ?>
                ...
                <div class="container v2">
                    <div class="row">
                        ...
                        <div class="footer-column-1 col-lg-3 col-md-12">
                            <img src="../assets/images/logo_300x300.webp" style="background: #000000">
